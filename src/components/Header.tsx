    ...
    <header className="site-header sticky top-0 z-[80] backdrop-blur">
      ...
      {open ? (
        <div className="fixed inset-0 z-[100] md:hidden">
          <button className="absolute inset-0 bg-black/50" type="button" aria-label="Close" onClick={() => setOpen(false)} />
          <aside className="absolute right-0 top-0 flex h-dvh w-[min(80vw,300px)] flex-col border-l shadow-2xl" style={{ background: "var(--bg2)", borderColor: "var(--border)", color: "var(--fg)" }}>
