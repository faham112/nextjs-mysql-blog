...
export default function AdminToolsPage() {
  ...
  async function run(action: "migrate" | "publish") {
    setBusy(action);
  ...
  return (
    <div className="space-y-5">
      <div>
        ...
        <p className="mt-2 text-sm" style={{ color: "var(--muted)" }}>SQL tables and scheduled posts from here. phpMyAdmin only if env is missing.</p>
      </div>
