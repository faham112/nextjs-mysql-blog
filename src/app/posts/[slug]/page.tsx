...
export default async function PostPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <article className="mx-auto max-w-3xl px-4 py-8 sm:px-6">
      ...
      <p className="text-sm uppercase tracking-widest text-accent">{post.category_name || "Journal"}</p>
      ...
      {post.featured_image ? <img src={post.featured_image} alt="" className="mt-8 max-h-[420px] w-full rounded-2xl object-cover" /> : null}
