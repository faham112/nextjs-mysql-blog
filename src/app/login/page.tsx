    ...
    <div className="flex min-h-[75vh] items-center justify-center px-4 py-12">
      <div className="card w-full max-w-md space-y-6 p-8 sm:p-10">
        <div className="text-center">
          <img src="/logo.svg" alt="Global Career Hub" className="mx-auto h-14 w-14 rounded-2xl" />
          <h2 className="mt-3 font-heading text-2xl font-extrabold">Sign in</h2>
          <p className="mt-1 text-xs text-slate-500">Admin opens the control desk. Publishers open their own workspace.</p>
        </div>
