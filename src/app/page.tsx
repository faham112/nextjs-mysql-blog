    ...
    <>
      <section className="relative overflow-hidden border-b border-dark-800 bg-dark-900 py-20 text-white lg:py-28">
        ...
        <div className="relative z-10 mx-auto max-w-3xl px-4 text-center">
          <p className="inline-flex items-center gap-2 rounded-full border border-dark-700 bg-dark-800 px-3.5 py-1.5 text-xs font-bold uppercase tracking-wider text-brand-500">
            Official Editorial Hub by Abdul Faheem
          </p>
          <h1 className="mt-6 font-heading text-4xl font-extrabold leading-none tracking-tight sm:text-6xl">
            Guides & Insights for <span className="bg-gradient-to-r from-brand-500 to-red-400 bg-clip-text text-transparent">Careers, Skills & Study.</span>
          </h1>
          <p className="mx-auto mt-5 max-w-2xl text-base text-slate-400">
            High-value writing on work, tech, scholarships, and study paths. Read completely free.
          </p>
