    ...
    <>
      <section className="relative overflow-hidden border-b border-dark-800 bg-dark-900 py-20 text-white lg:py-28">
        ...
        <div className="relative z-10 mx-auto max-w-3xl px-4 text-center">
          <p className="inline-flex items-center gap-2 rounded-full border border-dark-700 bg-dark-800 px-3.5 py-1.5 text-xs font-bold uppercase tracking-wider text-brand-500">Career, skills and study guides</p>
