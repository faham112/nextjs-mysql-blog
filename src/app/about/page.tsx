    ...
    <div className="mx-auto max-w-3xl px-4 py-16">
      ...
      <div className="card mt-8 space-y-5 p-8">
        ...
        <p className="text-sm leading-7" style={{ color: "var(--fg)" }}>
          I publish short, practical guides for students and early-career readers who are filling
          forms at night — scholarships, skills, study routes, and the first years of work.
          The site is a reading desk. It is not a consultancy, a visa shop, or a job board.
        </p>
        <p className="text-sm leading-7" style={{ color: "var(--fg)" }}>
          When a page names a programme, it also points at the official source: HEC, DAAD,
          Chevening, GOV.UK, USEFP, and the rest. If this site and that page disagree, trust the
        ...
        <p className="text-sm leading-7" style={{ color: "var(--fg)" }}>
          ...
          <Link className="font-semibold text-brand-600" href="/posts/official-scholarship-map-pakistan-2026-hec-fulbright-daad">
            the scholarship map
          </Link>
          ,{" "}
          <Link className="font-semibold text-brand-600" href="/posts/germany-2026-pakistani-students-daad-aps-calendar">
            Germany / DAAD
          </Link>
          , and{" "}
          <Link className="font-semibold text-brand-600" href="/posts/uk-skilled-worker-visa-sponsor-check-2026">
            UK sponsor checks
          </Link>
          .
        </p>
