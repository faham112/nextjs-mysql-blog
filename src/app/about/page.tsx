  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-16">
      ...
      <div className="card mt-8 space-y-5 p-8">
        ...
        <p className="text-sm leading-7 text-slate-700">Global Career Hub is a small reading site, not a recruitment agency. The pages here are guides I would have wanted when filling forms at midnight.</p>
